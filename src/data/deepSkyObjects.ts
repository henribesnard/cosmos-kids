...
const DEEP_SKY_CATALOG: Record<DeepSkyObjectId, DeepSkyObject> = {
  ...
  'sgr-a': {
    ...
    diameterLy: 0,
    facts: [
      { label: T('Masse', 'Mass'), value: T('4,15 millions M☉', '4.15 million M☉') },
      { label: T('Distance', 'Distance'), value: T('26 673 al', '26,673 ly') },
      { label: T('Rayon de Schwarzschild', 'Schwarzschild radius'), value: T('12,4 millions km', '12.4 million km') },
  ...
  'crab-nebula': {
    ...
    funFact: T(
      'Le Crabe grandit encore ! Le nuage s\u2019étend à 1 500 km/s — presque un millième de la vitesse de la lumière.',
      'The Crab is still growing! The cloud expands at 1,500 km/s — nearly one thousandth of the speed of light.',
    ),
    color: '#60b8e0',
    symbol: '🦀',
