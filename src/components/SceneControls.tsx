...
interface SceneControlsProps {
  ...
  showLabels: boolean;
  showOrbits: boolean;
  /** Galactic views only need the shared label toggle. */
  labelsOnly?: boolean;
  timeScale: number;
...
export function SceneControls({ locale, showLabels, showOrbits, labelsOnly = false, timeScale, snapshotDate, onLabels, onOrbits, onTimeScale, onSnapshotDate }: SceneControlsProps) {
  const fr = locale === 'fr';
  ...
  return (
    <div className="scene-controls glass-panel" data-scene-obstacle aria-label={fr ? 'Contrôles de la scène' : 'Scene controls'}>
      {!labelsOnly && (
